...
# Excluded dirs (forward-slash RELATIVE path prefixes): git internals, scratch/temp,
# legacy snapshots, ephemeral health logs, media, third-party skill import cache
...
# Prune tracked .md in the clone that no longer exist in the workspace
Set-Location $cl
...
$stale | Select-Object -First 20 | ForEach-Object { Write-Output "  pruned: $_" }

# Secret scan across everything in the clone (outside .git), grouped summary
