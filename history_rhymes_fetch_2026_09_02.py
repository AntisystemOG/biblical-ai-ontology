#!/usr/bin/env python3
"""History Rhymes data fetcher for September 2, 2026 (pre-market).
...
OUTPUT = r'C:\Users\thadd\OneDrive\Desktop\Spocks Reports\history_rhymes\2026-09-02_history_rhymes_data.json'
...
news = {}
for cat, q in [
    ("stock_market", "stock market today selloff"),
    ("fed_rates", "Federal Reserve Warsh rate hike"),
    ("oil_iran", "oil prices Iran strike"),
    ("ai_valuation", "AI bubble stocks valuation"),
    ("inflation", "inflation CPI report"),
    ("jobs", "jobs report payrolls August"),
]:
